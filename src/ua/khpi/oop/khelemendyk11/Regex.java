...
public final class Regex {
     ...
     */
    public static final String SIMPLE_STRING_REGEX = "^[A-Za-zА-ЩЬЮЯҐІЇЄЫа-щьюяґіїєы0-9'.,\\- ]+$";
    public static final String ISBN_REGEX = "^[0-9]{3}-[0-9]{3}-[0-9]{6}-[0-9]$";
    public static final String GENRE_REGEX = "^[A-Za-zА-ЩЬЮЯҐІЇЄЫа-щьюяґіїєы']+$";
    public static final String AUTHOR_REGEX = "^[A-Za-zА-ЩЬЮЯҐІЇЄЫа-щьюяґіїєы'.,\\- ]+$";
