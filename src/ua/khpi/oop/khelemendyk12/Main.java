...
import static ua.khpi.oop.khelemendyk12.ValidatorUtil.*;

/**
 * Завдання: Продемонструвати ефективне (оптимальне) використання регулярних виразів при вирішенні прикладної задачі.
